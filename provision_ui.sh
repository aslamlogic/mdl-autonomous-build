...
# 1. Update the API to serve a Root UI and static files
cat > meta_ui/main.py <<'PY'
...
# 3. Commit and Push to trigger Render
git add meta_ui/main.py requirements.txt
git commit -m "UI: provision autonomous dashboard and health routes"
git push origin main

echo "UI PROVISIONED. Wait 2-3 minutes for Render to cycle."
